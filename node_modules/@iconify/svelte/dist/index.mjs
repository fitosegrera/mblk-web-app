...
export { _api, addAPIProvider, addCollection, addIcon, buildIcon, calculateSize, Icon as default, disableCache, enableCache, getIcon, iconExists, listIcons, loadIcons, replaceIDs };
